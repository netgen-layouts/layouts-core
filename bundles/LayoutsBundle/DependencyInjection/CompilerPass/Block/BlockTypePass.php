...
{
    private const string SERVICE_NAME = 'netgen_layouts.block.registry.block_type';
    ...
    private function buildBlockTypes(ContainerBuilder $container, array $blockTypes): iterable
    {
        foreach ($blockTypes as $identifier => $blockType) {
            ...
            $container->register($serviceIdentifier, BlockType::class)
                ...
                ->setFactory([new Reference('netgen_layouts.block.block_type_factory'), 'buildBlockType']);
