...
use Netgen\Bundle\BlockManagerBundle\ParamConverter\Page\LayoutInfoParamConverter;
...
class LayoutInfoParamConverterTest extends TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->paramConverter = new LayoutInfoParamConverter($this->layoutServiceMock);
    }
    ...
    {
        $this->assertEquals(APILayoutInfo::class, $this->paramConverter->getSupportedClass());
    }
