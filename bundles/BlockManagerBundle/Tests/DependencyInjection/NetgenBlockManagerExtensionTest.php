...
class NetgenBlockManagerExtensionTest extends AbstractExtensionTestCase
{
    ...
    public function testParameters()
    {
        ...
        $this->assertContainerBuilderHasParameter('netgen_block_manager.query_view', array());
    ...
    public function testServices()
    {
        ...
        $this->assertContainerBuilderHasService('netgen_block_manager.validator.block_definition');
        ...
        $this->assertContainerBuilderHasService('netgen_block_manager.collection.query.form.edit');
        $this->assertContainerBuilderHasService('netgen_block_manager.renderer.block');
