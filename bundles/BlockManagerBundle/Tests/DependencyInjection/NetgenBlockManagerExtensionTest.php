...
class NetgenBlockManagerExtensionTest extends AbstractExtensionTestCase
{
    ...
    public function testServices()
    {
        ...
        $this->assertContainerBuilderHasService('netgen_block_manager.form.block_edit');
        ...
        $this->assertContainerBuilderHasService('netgen_block_manager.api.block.core.service');
