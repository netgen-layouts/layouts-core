...
{
    private const SERVICE_NAME = 'netgen_block_manager.parameters.registry.parameter_filter';
    private const TAG_NAME = 'netgen_block_manager.parameters.parameter_filter';
