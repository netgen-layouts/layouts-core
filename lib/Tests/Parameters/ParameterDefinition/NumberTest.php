...
use Netgen\BlockManager\Parameters\ParameterDefinition\Number;
use PHPUnit\Framework\TestCase;

class NumberTest extends TestCase
{
    /**
     * @covers \Netgen\BlockManager\Parameters\ParameterDefinition\Number::getType
     */
    public function testGetType()
    {
        $parameterDefinition = $this->getParameterDefinition();
        $this->assertEquals('number', $parameterDefinition->getType());
    }

    /**
     * @covers \Netgen\BlockManager\Parameters\ParameterDefinition\Number::getDefaultValue
     *
     * @param array $options
     * @param bool $required
    ...
    /**
     * @covers \Netgen\BlockManager\Parameters\ParameterDefinition\Number::getOptions
     * @covers \Netgen\BlockManager\Parameters\ParameterDefinition\Number::configureOptions
     ...
     * @param mixed $defaultValue
     *
     * @return \Netgen\BlockManager\Parameters\ParameterDefinition\Number
     */
