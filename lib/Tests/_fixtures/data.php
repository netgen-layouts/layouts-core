...
return array(
    ...
    'ngbm_block' => array(
        ...
        array('id' => 2, 'status' => 0, 'layout_id' => 1, 'zone_identifier' => 'right', 'position' => 1, 'definition_identifier' => 'list', 'view_type' => 'grid', 'item_view_type' => 'standard', 'name' => 'My other block', 'parameters' => '{"number_of_columns": 3}'),
        array('id' => 2, 'status' => 1, 'layout_id' => 1, 'zone_identifier' => 'right', 'position' => 1, 'definition_identifier' => 'list', 'view_type' => 'grid', 'item_view_type' => 'standard', 'name' => 'My other block', 'parameters' => '{"number_of_columns": 3}'),
        ...
        array('id' => 4, 'status' => 0, 'layout_id' => 2, 'zone_identifier' => 'right', 'position' => 1, 'definition_identifier' => 'title', 'view_type' => 'title', 'item_view_type' => 'standard', 'name' => 'My fourth block', 'parameters' => '{"tag": "h3", "title": "Title"}'),
        array('id' => 4, 'status' => 1, 'layout_id' => 2, 'zone_identifier' => 'right', 'position' => 1, 'definition_identifier' => 'title', 'view_type' => 'title', 'item_view_type' => 'standard', 'name' => 'My fourth block', 'parameters' => '{"tag": "h3", "title": "Title"}'),
        array('id' => 5, 'status' => 0, 'layout_id' => 1, 'zone_identifier' => 'right', 'position' => 2, 'definition_identifier' => 'list', 'view_type' => 'grid', 'item_view_type' => 'standard', 'name' => 'My fourth block', 'parameters' => '{"number_of_columns": 3}'),
        array('id' => 5, 'status' => 1, 'layout_id' => 1, 'zone_identifier' => 'right', 'position' => 2, 'definition_identifier' => 'list', 'view_type' => 'grid', 'item_view_type' => 'standard', 'name' => 'My fourth block', 'parameters' => '{"number_of_columns": 3}'),
        array('id' => 6, 'status' => 0, 'layout_id' => 2, 'zone_identifier' => 'right', 'position' => 2, 'definition_identifier' => 'title', 'view_type' => 'title', 'item_view_type' => 'standard', 'name' => 'My sixth block', 'parameters' => '{"tag": "h3", "title": "Title"}'),
    ),
