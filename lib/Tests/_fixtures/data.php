...
return array(
    'ngbm_layout' => array(
        array('id' => 1, 'status' => 0, 'type' => '3_zones_a', 'name' => 'My layout', 'created' => 1447065813, 'modified' => 1447065813),
        array('id' => 1, 'status' => 1, 'type' => '3_zones_a', 'name' => 'My layout', 'created' => 1447065813, 'modified' => 1447065813),
        array('id' => 2, 'status' => 0, 'type' => '3_zones_b', 'name' => 'My other layout', 'created' => 1447065813, 'modified' => 1447065813),
        array('id' => 2, 'status' => 1, 'type' => '3_zones_b', 'name' => 'My other layout', 'created' => 1447065813, 'modified' => 1447065813),
        array('id' => 3, 'status' => 1, 'type' => '3_zones_b', 'name' => 'My third layout', 'created' => 1447065813, 'modified' => 1447065813),
        array('id' => 4, 'status' => 0, 'type' => '3_zones_b', 'name' => 'My fourth layout', 'created' => 1447065813, 'modified' => 1447065813),
    ),
    'ngbm_zone' => array(
    ...
    'ngbm_block' => array(
        array('id' => 1, 'status' => 0, 'layout_id' => 1, 'zone_identifier' => 'top_right', 'position' => 0, 'definition_identifier' => 'paragraph', 'view_type' => 'default', 'item_view_type' => 'standard', 'name' => 'My block', 'parameters' => '{"content": "Paragraph"}'),
        array('id' => 1, 'status' => 1, 'layout_id' => 1, 'zone_identifier' => 'top_right', 'position' => 0, 'definition_identifier' => 'paragraph', 'view_type' => 'default', 'item_view_type' => 'standard', 'name' => 'My block', 'parameters' => '{"content": "Paragraph"}'),
        array('id' => 2, 'status' => 0, 'layout_id' => 1, 'zone_identifier' => 'top_right', 'position' => 1, 'definition_identifier' => 'title', 'view_type' => 'small', 'item_view_type' => 'standard', 'name' => 'My other block', 'parameters' => '{"tag": "h1", "title": "Title"}'),
        array('id' => 2, 'status' => 1, 'layout_id' => 1, 'zone_identifier' => 'top_right', 'position' => 1, 'definition_identifier' => 'title', 'view_type' => 'small', 'item_view_type' => 'standard', 'name' => 'My other block', 'parameters' => '{"tag": "h1", "title": "Title"}'),
        array('id' => 3, 'status' => 0, 'layout_id' => 2, 'zone_identifier' => 'bottom_right', 'position' => 0, 'definition_identifier' => 'paragraph', 'view_type' => 'large', 'item_view_type' => 'standard', 'name' => 'My third block', 'parameters' => '{"content": "Paragraph"}'),
        array('id' => 3, 'status' => 1, 'layout_id' => 2, 'zone_identifier' => 'bottom_right', 'position' => 0, 'definition_identifier' => 'paragraph', 'view_type' => 'large', 'item_view_type' => 'standard', 'name' => 'My third block', 'parameters' => '{"content": "Paragraph"}'),
        array('id' => 4, 'status' => 0, 'layout_id' => 2, 'zone_identifier' => 'bottom_right', 'position' => 1, 'definition_identifier' => 'title', 'view_type' => 'small', 'item_view_type' => 'standard', 'name' => 'My fourth block', 'parameters' => '{"tag": "h3", "title": "Title"}'),
        array('id' => 4, 'status' => 1, 'layout_id' => 2, 'zone_identifier' => 'bottom_right', 'position' => 1, 'definition_identifier' => 'title', 'view_type' => 'small', 'item_view_type' => 'standard', 'name' => 'My fourth block', 'parameters' => '{"tag": "h3", "title": "Title"}'),
        array('id' => 5, 'status' => 0, 'layout_id' => 1, 'zone_identifier' => 'top_right', 'position' => 2, 'definition_identifier' => 'title', 'view_type' => 'small', 'item_view_type' => 'standard', 'name' => 'My fourth block', 'parameters' => '{"tag": "h3", "title": "Title"}'),
        array('id' => 5, 'status' => 1, 'layout_id' => 1, 'zone_identifier' => 'top_right', 'position' => 2, 'definition_identifier' => 'title', 'view_type' => 'small', 'item_view_type' => 'standard', 'name' => 'My fourth block', 'parameters' => '{"tag": "h3", "title": "Title"}'),
        array('id' => 6, 'status' => 0, 'layout_id' => 2, 'zone_identifier' => 'bottom_right', 'position' => 2, 'definition_identifier' => 'title', 'view_type' => 'small', 'item_view_type' => 'standard', 'name' => 'My sixth block', 'parameters' => '{"tag": "h3", "title": "Title"}'),
    ),
    ...
    'ngbm_collection_query' => array(
        array('id' => 1, 'status' => 1, 'collection_id' => 2, 'position' => 0, 'identifier' => 'default', 'type' => 'ezcontent_search', 'parameters' => '{"parent_location_id": 2}'),
        array('id' => 2, 'status' => 0, 'collection_id' => 3, 'position' => 0, 'identifier' => 'default', 'type' => 'ezcontent_search', 'parameters' => '{"parent_location_id": 2}'),
        array('id' => 2, 'status' => 1, 'collection_id' => 3, 'position' => 0, 'identifier' => 'default', 'type' => 'ezcontent_search', 'parameters' => '{"parent_location_id": 2}'),
        array('id' => 3, 'status' => 0, 'collection_id' => 3, 'position' => 1, 'identifier' => 'featured', 'type' => 'ezcontent_search', 'parameters' => '{"parent_location_id": 2}'),
        array('id' => 3, 'status' => 1, 'collection_id' => 3, 'position' => 1, 'identifier' => 'featured', 'type' => 'ezcontent_search', 'parameters' => '{"parent_location_id": 2}'),
        array('id' => 4, 'status' => 0, 'collection_id' => 4, 'position' => 0, 'identifier' => 'default', 'type' => 'ezcontent_search', 'parameters' => '{"parent_location_id": 2}'),
        array('id' => 4, 'status' => 1, 'collection_id' => 4, 'position' => 0, 'identifier' => 'default', 'type' => 'ezcontent_search', 'parameters' => '{"parent_location_id": 2}'),
    ),
