...
final class MoveTest extends JsonApiTestCase
{
    ...
    public function testMove(): void
    {
        ...
        $this->client->request(
            Request::METHOD_POST,
            '/nglayouts/api/app/en/blocks/42446cc9-24c3-573c-9022-6b3a764727b5/move',
            [],
            [],
            [],
            $data
    ...
    public function testMoveToDifferentPlaceholder(): void
    {
        ...
        $this->client->request(
            Request::METHOD_POST,
            '/nglayouts/api/app/en/blocks/129f51de-a535-5094-8517-45d672e06302/move',
            [],
            [],
            [],
            $data
    ...
    public function testMoveWithNonExistentTargetBlock(): void
    {
        ...
        $this->client->request(
            Request::METHOD_POST,
            '/nglayouts/api/app/en/blocks/b07d3a85-bcdb-5af2-9b6f-deba36c700e7/move',
            [],
            [],
            [],
            $data
    ...
    public function testMoveWithNonContainerTargetBlock(): void
    {
        ...
        $this->client->request(
            Request::METHOD_POST,
            '/nglayouts/api/app/en/blocks/28df256a-2467-5527-b398-9269ccc652de/move',
            [],
            [],
            [],
            $data
    ...
    public function testMoveWithContainerInsideContainer(): void
    {
        ...
        $this->client->request(
            Request::METHOD_POST,
            '/nglayouts/api/app/en/blocks/e666109d-f1db-5fd5-97fa-346f50e9ae59/move',
            [],
            [],
            [],
            $data
