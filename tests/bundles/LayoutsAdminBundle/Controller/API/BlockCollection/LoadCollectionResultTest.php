...
final class LoadCollectionResultTest extends JsonApiTestCase
{
    ...
    {
        $this->client->request(Request::METHOD_GET, '/nglayouts/api/app/en/blocks/c2a30ea3-95ef-55b0-a584-fbcfd93cec9e/collections/default/result');
    ...
    {
        $this->client->request(Request::METHOD_GET, '/nglayouts/api/app/en/blocks/ffffffff-ffff-ffff-ffff-ffffffffffff/collections/default/result');
    ...
    {
        $this->client->request(Request::METHOD_GET, '/nglayouts/api/app/en/blocks/28df256a-2467-5527-b398-9269ccc652de/collections/unknown/result');
