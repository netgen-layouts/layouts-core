...
{
    /**
     * @covers \Netgen\Bundle\LayoutsBundle\Controller\API\V1\Layout\Copy::__construct
     * @covers \Netgen\Bundle\LayoutsBundle\Controller\API\V1\Layout\Copy::__invoke
     */
    public function testCopy(): void
    {
        ...
        $this->client->request(
            Request::METHOD_POST,
            '/nglayouts/api/v1/layouts/1/copy?html=false',
            [],
            [],
            [],
            $data
    ...
    public function testCopyInPublishedState(): void
    {
        ...
        $this->client->request(
            Request::METHOD_POST,
            '/nglayouts/api/v1/layouts/6/copy?published=true&html=false',
            [],
            [],
            [],
            $data
    ...
    public function testCopyWithNonExistingLayout(): void
    {
        ...
        $this->client->request(
            Request::METHOD_POST,
            '/nglayouts/api/v1/layouts/9999/copy',
            [],
            [],
            [],
            $data
    ...
    public function testCopyWithInvalidName(): void
    {
        ...
        $this->client->request(
            Request::METHOD_POST,
            '/nglayouts/api/v1/layouts/1/copy',
            [],
            [],
            [],
            $data
