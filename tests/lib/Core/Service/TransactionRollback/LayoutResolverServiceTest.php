...
final class LayoutResolverServiceTest extends TestCase
{
    ...
    public function testUpdateRule(): void
    {
        ...
        $this->layoutResolverService->updateRule(
            Rule::fromArray(['id' => Uuid::v7(), 'status' => Status::Draft]),
    ...
    public function testUpdateRuleMetadata(): void
    {
        ...
        $this->layoutResolverService->updateRuleMetadata(
            Rule::fromArray(['id' => Uuid::v7(), 'status' => Status::Published]),
    ...
    public function testCreateRuleDraft(): void
    {
        ...
        $this->layoutResolverService->createRuleDraft(Rule::fromArray(['id' => Uuid::v7(), 'status' => Status::Published]));
    }
    ...
    public function testDiscardRuleDraft(): void
    {
        ...
        $this->layoutResolverService->discardRuleDraft(Rule::fromArray(['id' => Uuid::v7(), 'status' => Status::Draft]));
    }
    ...
    public function testPublishRule(): void
    {
        ...
        $this->layoutResolverService->publishRule(Rule::fromArray(['id' => Uuid::v7(), 'status' => Status::Draft]));
    }
    ...
    public function testRestoreRuleFromArchive(): void
    {
        ...
        $this->layoutResolverService->restoreRuleFromArchive(Rule::fromArray(['id' => Uuid::v7(), 'status' => Status::Archived]));
    }
    ...
    public function testDeleteRule(): void
    {
        ...
        $this->layoutResolverService->deleteRule(Rule::fromArray(['id' => Uuid::v7(), 'status' => Status::Draft]));
    }
    ...
    public function testEnableRule(): void
    {
        ...
        $this->layoutResolverService->enableRule(Rule::fromArray(['id' => Uuid::v7(), 'status' => Status::Published]));
    }
    ...
    public function testDisableRule(): void
    {
        ...
        $this->layoutResolverService->disableRule(Rule::fromArray(['id' => Uuid::v7(), 'status' => Status::Published]));
    }
    ...
    public function testUpdateRuleGroup(): void
    {
        ...
        $this->layoutResolverService->updateRuleGroup(
            RuleGroup::fromArray(['id' => Uuid::v7(), 'status' => Status::Draft]),
    ...
    public function testUpdateRuleGroupMetadata(): void
    {
        ...
        $this->layoutResolverService->updateRuleGroupMetadata(
            RuleGroup::fromArray(['id' => Uuid::v7(), 'status' => Status::Published]),
    ...
    public function testRestoreRuleGroupFromArchive(): void
    {
        ...
        $this->layoutResolverService->restoreRuleGroupFromArchive(
            RuleGroup::fromArray(['id' => Uuid::v7(), 'status' => Status::Archived]),
        );
    }
    ...
    public function testUpdateTarget(): void
    {
        ...
        $this->layoutResolverService->updateTarget(
            Target::fromArray(['id' => Uuid::v7(), 'status' => Status::Draft, 'targetType' => new Route()]),
            $targetUpdateStruct,
        );
    }
    ...
    public function testDeleteTarget(): void
    {
        ...
        $this->layoutResolverService->deleteTarget(Target::fromArray(['id' => Uuid::v7(), 'status' => Status::Draft]));
    }
    ...
    public function testUpdateRuleCondition(): void
    {
        ...
        $this->layoutResolverService->updateRuleCondition(
            RuleCondition::fromArray(['id' => Uuid::v7(), 'status' => Status::Draft, 'conditionType' => new RouteParameter()]),
    ...
    public function testUpdateRuleGroupCondition(): void
    {
        ...
        $this->layoutResolverService->updateRuleGroupCondition(
            RuleGroupCondition::fromArray(['id' => Uuid::v7(), 'status' => Status::Draft, 'conditionType' => new RouteParameter()]),
            $conditionUpdateStruct,
        );
    }
    ...
    public function testDeleteCondition(): void
    {
        ...
        $this->layoutResolverService->deleteCondition(RuleCondition::fromArray(['id' => Uuid::v7(), 'status' => Status::Draft]));
    }
}
