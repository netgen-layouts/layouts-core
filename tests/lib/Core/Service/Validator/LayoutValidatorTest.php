...
class LayoutValidatorTest extends TestCase
{
    ...
    {
        return array(
            array(array('layoutType' => $this->getLayoutType(), 'name' => 'Name', 'description' => 'Description', 'shared' => null), true),
            array(array('layoutType' => $this->getLayoutType(), 'name' => 'Name', 'description' => 'Description', 'shared' => false), true),
            array(array('layoutType' => $this->getLayoutType(), 'name' => 'Name', 'description' => 'Description', 'shared' => true), true),
            array(array('layoutType' => null, 'name' => 'Name', 'description' => 'Description', 'shared' => null), false),
            array(array('layoutType' => 42, 'name' => 'Name', 'description' => 'Description', 'shared' => null), false),
            array(array('layoutType' => $this->getLayoutType(), 'name' => null, 'description' => 'Description', 'shared' => null), false),
            array(array('layoutType' => $this->getLayoutType(), 'name' => '', 'description' => 'Description', 'shared' => null), false),
            array(array('layoutType' => $this->getLayoutType(), 'name' => '   ', 'description' => 'Description', 'shared' => null), false),
            array(array('layoutType' => $this->getLayoutType(), 'name' => 42, 'description' => 'Description', 'shared' => null), false),
            array(array('layoutType' => $this->getLayoutType(), 'name' => 'Name', 'description' => 42, 'shared' => null), false),
            array(array('layoutType' => $this->getLayoutType(), 'name' => 'Name', 'description' => null, 'shared' => null), true),
            array(array('layoutType' => $this->getLayoutType(), 'name' => 'Name', 'description' => '', 'shared' => null), true),
    ...
    public function validateLayoutUpdateStructDataProvider()
    {
        return array(
            ...
            array(array('name' => null, 'description' => 'New description'), true),
