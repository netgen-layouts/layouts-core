...
final class PagedCollectionsPluginTest extends TestCase
{
    ...
    {
        $this->plugin = new PagedCollectionsPlugin(array('load_more' => 'Load more'), array('group'));
    ...
    public function testBuildParameters()
    {
        ...
        $this->assertEquals(array('group'), $builder->get('paged_collections:enabled')->getGroups());
        ...
        $this->assertEquals(array('group'), $compoundBuilder->get('paged_collections:type')->getGroups());
        $this->assertEquals(array('Load more' => 'load_more'), $compoundBuilder->get('paged_collections:type')->getOption('options'));
        ...
        $this->assertEquals(array('group'), $compoundBuilder->get('paged_collections:max_pages')->getGroups());
        ...
        $this->assertEquals(array('group'), $compoundBuilder->get('paged_collections:ajax_first')->getGroups());
