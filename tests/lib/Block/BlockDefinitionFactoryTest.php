...
final class BlockDefinitionFactoryTest extends TestCase
{
    ...
    {
        $parameterTypeRegistry = new ParameterTypeRegistry([TextLineType::getIdentifier() => new TextLineType()]);
    ...
    public function testBuildBlockDefinition(): void
    {
        ...
        self::assertArrayHasKey('test_param', $blockDefinition->parameterDefinitions);
