...
#[CoversClass(QueryParameterMapper::class)]
final class QueryParameterMapperTest extends TestCase
{
    private QueryParameterMapper $mapper;

    protected function setUp(): void
    {
        $this->mapper = new QueryParameterMapper();
    }
